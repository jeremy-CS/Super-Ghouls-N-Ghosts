...
public class Boss_01 : MonoBehaviour
{
    ...
    [SerializeField] private Level_complete level_Complete;
    ...
    public void Attack()
    {
        ...
        if(time_attack >= attack_frequency)
        {
            mAttacking = true;
            mIdle = false;
            Instantiate(fire_prefab, GameObject.FindGameObjectWithTag("boss_projectile").transform.position, Quaternion.identity);
    ...
    public void UpdateAnimator()
    {
        ...
        Boss_animator.SetBool("isAttacking", mAttacking);
